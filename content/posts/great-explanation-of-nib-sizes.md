...
* MK (rounded medium). A special nib made by [Lamy](showcat.php?brand=Lamy&cat=pens) with a more rounded point such that the orientation of the pen relative to the paper is less critical than a standard point and therefore easier for beginners. The designation is no longer used but the current Lamy medium nib is made to the same specification as the MK.
